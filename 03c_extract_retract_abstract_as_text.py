...
source_directory = '../data/json_files/cellbiology_retracted_fulljsonfiles'
output_csv_path = '../data/cellbio_abstracts/cellbio_abstracts_retracted_text.csv'
log_csv_path = '../data/cellbio_abstracts/cellbio_abstracts_retracted_error_log.csv'
