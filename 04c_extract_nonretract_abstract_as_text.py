...
source_directory = "../data/json_files/json_jenny"
output_csv_path = '../data/cellbio_abstracts/cellbio_abstracts_non-retracted_text.csv'
log_csv_path = '../data/cellbio_abstracts/cellbio_abstracts_non-retracted_error_log.csv'
